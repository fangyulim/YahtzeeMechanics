...
{
    sf::Clock clock;
    sf::Time time_elapsed = sf::seconds(2);
...
void Graphics::C2draw()
{
     ...
     while (window.isOpen())
     {
         ...
         //die.setTexture(dices[0]);
        // die.setScale(0.25f,0.25f);
         //die.setPosition(1200, 100);
        ...
        // sf::Text TWOS2;
         ...
         if (sf::Keyboard::isKeyPressed(sf::Keyboard::Space))
         {
             cout << "The rolling stopped! Now choose your dice!";
             cout << endl;
             system("pause");
         }
     }
