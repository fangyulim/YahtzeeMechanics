...
void Graphics::C2draw()
{
    ...
    while (window.isOpen())
    {
        ...
        // if (!dices[0].loadFromFile("dice1.jpg",sf::IntRect(1200,100,100,100)));
        ...
        while (numRoll < 3)
        {
            ...
            pick_dice1.setFont(font);
            pick_dice1.setString("Pick dice 1? Enter(Y), Esc(N)");
            pick_dice1.setFillColor(sf::Color::Black);
            pick_dice1.setPosition(950, 100);
       ...
       // }
        sf::Text p1;
        // select the font
        p1.setFont(font); // font is a sf::Font
        // set the string to display
        p1.setString("Player 1");
        // set the character size
        p1.setCharacterSize(50); // in pixels, not points!
        // set the color
        ...
        THREES1.setString(ss4.str().c_str());
        ...
        THREES2.setString(ss5.str().c_str());
        ...
        sf::Text FOURS1;
        FOURS1.setFont(font);
        FOURS1.setString(ss6.str().c_str());
        ...
        sf::Text FOURS2;
        FOURS2.setFont(font);
        FOURS2.setString(ss7.str().c_str());
        ...
        sf::Text FIVES1;
        FIVES1.setFont(font);
        FIVES1.setString(ss8.str().c_str());
        ...
        sf::Text FIVES2;
        FIVES2.setFont(font);
        FIVES2.setString(ss9.str().c_str());
